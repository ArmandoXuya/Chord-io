...
@Component({
  selector: 'app-restclave',
  templateUrl: './restclave.page.html',
  styleUrls: ['./restclave.page.scss'],
})
  ...
  isToastOpen = false;
   ...
   togglePass(){
    ...
    onSubmitTemplate(){
      ...
      this.userService.resetpasswordClient(this.usuario)
     .then((response:any) =>{
     // this.router.navigate(['/login'])
     this.errorStatus=true;
     this.isToastOpen=true
     this.errorMsgTit="Envio de Restablecimiento"
     this.errorMsj="Se envio un correo para restablecer tu clave verifica tu bandeja de entrada";
